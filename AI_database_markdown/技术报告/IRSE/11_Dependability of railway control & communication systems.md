...
• e.g. At population level, for 120 items, there are 50 failures in a year. The average MTBF for an individual item is  $120 / 50 = 2.4$  years.
...
- Railroad contamination (failing to detect a train)
...
$$
\text {A v a i l a b i l i t y} = \text {U p t i m e / (U p t i m e + D o w n t i m e)}
$$

This is the equivalent of:

$$
\text {A v a i l a b i l i t y} = \text {M T T F / (M T T F + M T T R)}
$$
...
$\bigcirc$  Protection against external actions or events (usually confined to malicious ones)  
○ Will it work without being degraded by changes on disruptions?
